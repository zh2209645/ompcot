...
export const en = {
  ...
  "composer.thinkOff": "Think off",
  "composer.thinkLevel": "Think {level}",
  "composer.thinkingLevel": "Thinking: {level}",
  "composer.thinkingTitle": "Thinking effort controls reasoning depth. Click to cycle.",
  ...
  "settings.thinkingCycle": "Click to cycle: off, minimal, low, medium, high",
  "settings.thinkingLevelOff": "Thinking: off",
