...
export const en = {
  ...
  // ── models & reasoning (Configuration sub-page) ──
  "models.pageTitle": "Models & Reasoning",
  "models.mainSession": "Main session",
  "models.defaultModel": "Default model",
  "models.defaultThinking": "Default thinking depth",
  "models.defaultThinkingHint":
    "Applies to new sessions; use the composer depth menu for the current session",
  "models.modelRoles": "Model roles",
  "models.advisorHint": "advisor model",
  "models.notSet": "Not set",
  "models.notInList": "not in available list",
  "models.taskAgents": "Task agents",
  "models.sourceUser": "user",
  "models.sourceProject": "project",
  "models.definitionValue": "from definition file",
  "models.overrideModel": "Override model",
  "models.noOverride": "No override",
  "models.disabled": "Disabled",
  "models.parseError": "Definition parse error",
  "models.agentNote":
    "v1 adjusts models via settings overrides; edit definition files manually if needed",
  ...
  "models.thinkingAuto": "Auto",
  "models.clearRole": "Clear {name}",
